public class ACar extends Car{
    //fields
    public final int fuelCapacity = 80; //zarfiyat bak mashin
    public final CarType carType = CarType.A;
    private final FuelType carFuelType = FuelType.REGULAR;
    private int carFuelTank;
    
    

    //constructor
    public ACar(int money, int fuelLiter){
        super(money);
